...
# fill in code here
    Y = np.matrix(y)
    p_y_1, p_y_minus_1 = naivebayesPY(X, Y)

    pxy_1, pxy_minus_1 = naivebayesPXY(X, Y)

    p_y_1_x1 = p_y_1 * np.prod(pxy_1[X1 == 1])
    p_y_minus_1_x1 = p_y_minus_1 * np.prod(pxy_minus_1[X1 == 1])

    logratio = np.log(p_y_1_x1 / p_y_minus_1_x1)
